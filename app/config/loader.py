...
RATE_LIMIT_SECTIONS = {"routes": "RATE_LIMITS", "burst": "BURST_LIMITS", "services": "SERVICE_RATE_LIMITS"}
...
def _module(name: str):
    ...
    if name == "rate_limits":
        return sys.modules["app.config.rate_limits"]
...
_BINDERS: dict[str, Callable[..., None]] = {"rate_limit_full": _apply_rate_limit_full}
