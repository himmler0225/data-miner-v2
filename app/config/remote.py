import httpx
import app.config.rate_limits as rate_limits
import app.config.settings as settings
from app.config.http import REMOTE_CONFIG_TIMEOUT
...
async def load_and_apply() -> None:
    ...
    try:
        ...
        tmp = Limiter(key_func=get_identifier, default_limits=[rate_limits.RATE_LIMIT_DEFAULT, rate_limits.RATE_LIMIT_BURST])
